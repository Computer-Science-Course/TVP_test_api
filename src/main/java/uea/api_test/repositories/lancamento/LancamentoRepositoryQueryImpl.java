...
public class LancamentoRepositoryQueryImpl implements LancamentoRepositoryQuery {
	...
	private void adicionarRestricoesDePaginacao(TypedQuery<ResumoLancamentoDto> query, Pageable pageable) {
		int paginaTual = pageable.getPageNumber();
		int totalDeRegistroProPagina = pageable.getPageSize();
		int primeiroRegistroDaPagina = paginaTual * totalDeRegistroProPagina;
		
		query.setFirstResult(primeiroRegistroDaPagina);
		query.setMaxResults(totalDeRegistroProPagina);
